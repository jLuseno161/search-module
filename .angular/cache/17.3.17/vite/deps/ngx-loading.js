...
import {
  ...
  ɵɵpureFunction4,
  ɵɵtemplate
} from "./chunk-EZNAPCJA.js";
import "./chunk-L27PWHKT.js";
...
function NgxLoadingComponent_div_0_div_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction1(2, _c0, ctx_r0.config.fullScreenBackdrop === true))("ngStyle", ɵɵpureFunction4(4, _c2, ctx_r0.config.secondaryColour, ctx_r0.config.secondaryColour, ctx_r0.config.secondaryColour, ctx_r0.config.primaryColour));
  }
}
function NgxLoadingComponent_div_0_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 15);
    ɵɵelement(1, "div", 16)(2, "div", 17)(3, "div", 18)(4, "div", 19)(5, "div", 20)(6, "div", 21)(7, "div", 22)(8, "div", 23)(9, "div", 24);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(10, _c0, ctx_r0.config.fullScreenBackdrop === true));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(12, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(14, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(16, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(18, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(20, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(22, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(24, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(26, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(28, _c3, ctx_r0.config.primaryColour));
  }
}
function NgxLoadingComponent_div_0_div_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngStyle", ɵɵpureFunction1(2, _c3, ctx_r0.config.primaryColour))("ngClass", ɵɵpureFunction1(4, _c0, ctx_r0.config.fullScreenBackdrop === true));
  }
}
function NgxLoadingComponent_div_0_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 26);
    ɵɵelement(1, "div", 27)(2, "div", 28)(3, "div", 29)(4, "div", 30)(5, "div", 31);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(6, _c0, ctx_r0.config.fullScreenBackdrop === true));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(8, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(10, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(12, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(14, _c3, ctx_r0.config.primaryColour));
...
function NgxLoadingComponent_div_0_div_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵelement(1, "div", 33)(2, "div", 34);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(3, _c0, ctx_r0.config.fullScreenBackdrop === true));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(5, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(7, _c3, ctx_r0.config.secondaryColour));
  }
}
...
function NgxLoadingComponent_div_0_div_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(2, _c0, ctx_r0.config.fullScreenBackdrop === true))("ngStyle", ɵɵpureFunction1(4, _c3, ctx_r0.config.primaryColour));
  }
}
function NgxLoadingComponent_div_0_div_10_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 39);
    ɵɵelement(1, "div", 40)(2, "div", 41);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
...
function NgxLoadingComponent_div_0_div_11_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(2, _c0, ctx_r0.config.fullScreenBackdrop === true))("ngStyle", ɵɵpureFunction1(4, _c4, ctx_r0.config.primaryColour));
  }
}
function NgxLoadingComponent_div_0_div_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(1, _c0, ctx_r0.config.fullScreenBackdrop === true));
  }
}
function NgxLoadingComponent_div_0_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 44);
    ɵɵelement(1, "div", 45)(2, "div", 46)(3, "div", 47);
    ɵɵelementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵproperty("ngClass", ɵɵpureFunction1(4, _c0, ctx_r0.config.fullScreenBackdrop === true));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(6, _c3, ctx_r0.config.primaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(8, _c3, ctx_r0.config.secondaryColour));
    ɵɵadvance();
    ɵɵproperty("ngStyle", ɵɵpureFunction1(10, _c3, ctx_r0.config.tertiaryColour));
  }
}
...
function NgxLoadingComponent_div_0_ng_container_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(1, NgxLoadingComponent_div_0_ng_container_14_ng_container_1_Template, 1, 0, "ng-container", 48);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
...
function NgxLoadingComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵtemplate(3, NgxLoadingComponent_div_0_div_3_Template, 1, 9, "div", 3)(4, NgxLoadingComponent_div_0_div_4_Template, 10, 30, "div", 4)(5, NgxLoadingComponent_div_0_div_5_Template, 1, 6, "div", 5)(6, NgxLoadingComponent_div_0_div_6_Template, 6, 18, "div", 6)(7, NgxLoadingComponent_div_0_div_7_Template, 3, 9, "div", 7)(8, NgxLoadingComponent_div_0_div_8_Template, 3, 9, "div", 8)(9, NgxLoadingComponent_div_0_div_9_Template, 1, 6, "div", 9)(10, NgxLoadingComponent_div_0_div_10_Template, 3, 9, "div", 10)(11, NgxLoadingComponent_div_0_div_11_Template, 1, 6, "div", 11)(12, NgxLoadingComponent_div_0_div_12_Template, 1, 3, "div", 12)(13, NgxLoadingComponent_div_0_div_13_Template, 4, 12, "div", 13)(14, NgxLoadingComponent_div_0_ng_container_14_Template, 2, 1, "ng-container", 0);
    ɵɵelementEnd()();
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
    ɵɵadvance();
    ɵɵproperty("ngClass", ɵɵpureFunction1(14, _c0, ctx_r0.config.fullScreenBackdrop === true))("ngStyle", ɵɵpureFunction2(16, _c1, ctx_r0.config.backdropBorderRadius, ctx_r0.config.backdropBackgroundColour));
    ɵɵadvance();
    ɵɵproperty("ngSwitch", ctx_r0.config.animationType);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.circle);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.cubeGrid);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.rotatingPlane);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.rectangleBounce);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.wanderingCubes);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.doubleBounce);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.pulse);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.chasingDots);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.circleSwish);
    ɵɵadvance();
    ɵɵproperty("ngSwitchCase", ctx_r0.ngxLoadingAnimationTypes.none);
    ɵɵadvance(2);
    ɵɵproperty("ngIf", ctx_r0.template);
  }
}
var NgxLoadingConfig = class {
  constructor(config = {}) {
...
var NgxLoadingService = class _NgxLoadingService {
  constructor(config) {
    this.config = config;
    this.loadingConfig = this.config || new NgxLoadingConfig();
  }
  static {
    this.ɵfac = function NgxLoadingService_Factory(t) {
      return new (t || _NgxLoadingService)(ɵɵinject("loadingConfig", 8));
    };
  }
  static {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxLoadingService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
var NgxLoadingComponent = class _NgxLoadingComponent {
  ...
  static {
    this.ɵfac = function NgxLoadingComponent_Factory(t) {
      return new (t || _NgxLoadingComponent)(ɵɵdirectiveInject(NgxLoadingService));
    };
  }
  static {
...
var NgxLoadingModule = class _NgxLoadingModule {
  ...
  static {
    this.ɵfac = function NgxLoadingModule_Factory(t) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(NgxLoadingModule, [{
    type: NgModule,
    args: [{
      declarations: [NgxLoadingComponent],
      imports: [CommonModule],
